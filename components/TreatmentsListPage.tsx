...
const TreatmentsListPage: React.FC<TreatmentsListPageProps> = ({ onServiceSelect, onBack }) => {
    const [activeCategory, setActiveCategory] = useState<string>('Todos');

    const categories = ['Todos', 'Diagnóstico', 'Sueroterapia', 'Terapias', 'Estética', 'Multivitamínicos'];
            ...
            <div className="bg-white border-b border-slate-200 py-16 mb-12 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 md:px-6 relative z-10">
                    ...
                    <div className="max-w-4xl">
                        <h1 className="text-4xl md:text-6xl font-bold text-slate-900 mb-6">Catálogo PROMEDID</h1>
                        <p className="text-xl text-slate-600 leading-relaxed mb-4">
                            Encuentre el tratamiento ideal para su salud. Combinamos medicina alternativa con tecnología de vanguardia para su bienestar integral.
                        </p>
            ...
            <div className="container mx-auto px-4 md:px-6">
                ...
                {filteredTreatments.length === 0 && (
                    <div className="text-center py-20 bg-white rounded-3xl border border-dashed border-slate-300">
                        <p className="text-slate-500 text-lg">No se encontraron tratamientos en esta categoría.</p>
                        <button onClick={() => setActiveCategory('Todos')} className="text-emerald-600 font-bold mt-4 hover:underline">Ver todo el catálogo</button>
                    </div>
                )}
            </div>
            ...
            <div className="container mx-auto px-4 md:px-6 pt-20">
                <div className="bg-emerald-600 rounded-[2.5rem] p-8 md:p-12 text-white relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    <div className="relative z-10">
                        <button className="bg-white text-emerald-700 px-10 py-4 rounded-2xl font-bold text-lg hover:bg-emerald-50 transition-all shadow-xl">
